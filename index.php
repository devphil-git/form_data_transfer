...
<body>
   <div class="container">
      <form class="form" action="action.php" method="post">
         ...
         <input class="form__input form__input--phone" type="tel" name="phone" placeholder="Телефон">
         <input class="form__input" type="email" name="email" placeholder="Электронная почта">
         <input class="form__input form__input--date" type="date" name="date" value="2022-01-01">
